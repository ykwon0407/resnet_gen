...
def generate_deploy():
    ...
    network_str += generate_conv_layer(7, 64, 2, 3, 'new_conv1', 'scale_conv1')
    ...
    for l in xrange(1, args.layer_number[0]+1):
        ...
        network_str += generate_conv_layer(3, 64, 1, 1, 'res2%s_branch2b'%word[l], 'scale2%s_branch2a'%word[l])
        ...
        network_str += generate_conv_layer(1, 256, 1, 0, 'res2%s_branch2c'%word[l], 'scale2%s_branch2b'%word[l])
    ...
    network_str += generate_conv_layer(3, 128, 1, 1, 'res3_1_branch2b', 'scale3_1_branch2a')
    ...
    network_str += generate_conv_layer(1, 512, 1, 0, 'res3_1_branch2c', 'scale3_1_branch2b')
    ...
    for l in xrange(2, args.layer_number[1]+1):
        ...
        network_str += generate_conv_layer(3, 128, 1, 1, 'res3_%d_branch2b'%l, 'scale3_%d_branch2a'%l)
        ...
        network_str += generate_conv_layer(1, 512, 1, 0, 'res3_%d_branch2c'%l, 'scale3_%d_branch2b'%l)
    ...
    network_str += generate_conv_layer(3, 256, 1, 1, 'res4_1_branch2b', 'scale4_1_branch2a')
    ...
    network_str += generate_conv_layer(1, 1024, 1, 0, 'res4_1_branch2c', 'scale4_1_branch2b')
    ...
    for l in xrange(2, args.layer_number[2]+1):
        ...
        network_str += generate_conv_layer(3, 256, 1, 1, 'res4_%d_branch2b'%l, 'scale4_%d_branch2a'%l)
        ...
        network_str += generate_conv_layer(1, 1024, 1, 0, 'res4_%d_branch2c'%l, 'scale4_%d_branch2b'%l)
    ...
    network_str += generate_conv_layer(3, 512, 1, 1, 'res5_1_branch2b', 'scale5_1_branch2a')
    ...
    network_str += generate_conv_layer(1, 2048, 1, 0, 'res5_1_branch2c', 'scale5_1_branch2b')
    ...
    for l in xrange(2, args.layer_number[3]+1):
        ...
        network_str += generate_conv_layer(3, 512, 1, 1, 'res5_%d_branch2b'%l, 'scale5_%d_branch2a'%l)
        ...
        network_str += generate_conv_layer(1, 2048, 1, 0, 'res5_%d_branch2c'%l, 'scale5_%d_branch2b'%l)
