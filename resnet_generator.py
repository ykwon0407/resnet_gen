...
def generate_deploy():
    ...
    network_str += generate_conv_layer(7, 64, 2, 3, 'new_conv1', 'conv1_relu')
    ...
    network_str += generate_pooling_layer(3, 2, 'MAX', 'pool1', 'new_conv1_relu')
    '''stage 1'''
    last_top = 'pool1'
    ...
    for l in xrange(1, args.layer_number[0]+1):
        ...
        network_str += generate_conv_layer(3, 64, 1, 1, 'res2%s_branch2b'%word[l], 'res2%s_branch2a_relu'%word[l])
        ...
        network_str += generate_conv_layer(1, 256, 1, 0, 'res2%s_branch2c'%word[l], 'res2%s_branch2b_relu'%word[l])
        ...
        last_top = 'res2%s_relu'%word[l]
        last_output = 'res2%s_relu'%word[l]
    ...
    network_str += generate_conv_layer(3, 128, 1, 1, 'res3_1_branch2b', 'res3_1_branch2a_relu')
    ...
    network_str += generate_conv_layer(1, 512, 1, 0, 'res3_1_branch2c', 'res3_1_branch2b_relu')
    ...
    for l in xrange(2, args.layer_number[1]+1):
        ...
        network_str += generate_conv_layer(3, 128, 1, 1, 'res3_%d_branch2b'%l, 'res3_%d_branch2a_relu'%l)
        ...
        network_str += generate_conv_layer(1, 512, 1, 0, 'res3_%d_branch2c'%l, 'res3_%d_branch2b_relu'%l)
    ...
    network_str += generate_conv_layer(3, 256, 1, 1, 'res4_1_branch2b', 'res4_1_branch2a_relu')
    ...
    network_str += generate_conv_layer(1, 1024, 1, 0, 'res4_1_branch2c', 'res4_1_branch2b_relu')
    ...
    for l in xrange(2, args.layer_number[2]+1):
        ...
        network_str += generate_conv_layer(3, 256, 1, 1, 'res4_%d_branch2b'%l, 'res4_%d_branch2a_relu'%l)
        ...
        network_str += generate_conv_layer(1, 1024, 1, 0, 'res4_%d_branch2c'%l, 'res4_%d_branch2b_relu'%l)
    ...
    network_str += generate_conv_layer(3, 512, 1, 1, 'res5_1_branch2b', 'res5_1_branch2a_relu')
    ...
    network_str += generate_conv_layer(1, 2048, 1, 0, 'res5_1_branch2c', 'res5_1_branch2b_relu')
    ...
    for l in xrange(2, args.layer_number[3]+1):
        ...
        network_str += generate_conv_layer(3, 512, 1, 1, 'res5_%d_branch2b'%l, 'res5_%d_branch2a_relu'%l)
        ...
        network_str += generate_conv_layer(1, 2048, 1, 0, 'res5_%d_branch2c'%l, 'res5_%d_branch2b_relu'%l)
